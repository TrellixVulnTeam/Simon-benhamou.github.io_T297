...
router.put("/profileSetting/:userID",async(req,res) => {
    ...
    await User.updateOne({_id : userID}, {$set : {phoneNumber: req.body.details.phoneNumber,email: req.body.details.email,bio: req.body.details.bio,firstName: req.body.details.firstName,lastName: req.body.details.lastName}})
